...
namespace Lab06{
	public class MasterDetail : System.Windows.Forms.Form{
		...
		public MasterDetail(){
            ...
            SqlConnection cn = new SqlConnection(@"data source=AHMED;Initial Catalog=Northwind;Integrated Security=SSPI");
		...
		private void InitializeComponent(){
            ...
            this.Text = "Ahmed\'s Automatically synchronized Master-Detail";
